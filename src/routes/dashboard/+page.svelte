...
{#if !$authStore.loading}
  <div class="flex flex-col h-full w-full md:flex-row dark:bg-[#2A2D33]">
    <div
      ...
      class="text-black w-24 md:h-screen flex flex-col md:items-center md:border-r-2 bg-white md:px-8 z-20 dark:bg-[#1B1D21] dark:border-none"
      class:w-72={isOpen}
    >
      <div
        ...
        >
          ...
          <div class="flex md:justify-between justify-center items-center">
            <div class="flex md:gap-5 gap-10 justify-center">
              <button
                on:click={ongoing}
                class=" border-b-4 border-b-[#7864f4] transition-all duration-200 ease-in-out hover:text-[#553fe3]"
                >On Going</button
              >
            </div>
          </div>
