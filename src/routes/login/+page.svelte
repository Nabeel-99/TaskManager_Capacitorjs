...
<div class="flex flex-col gap-8 lg:gap-8  lg:flex-row min-h-[100vh]  p-10 rounded-md items-center lg:justify-around px-14 bg-[#f5f5f5] dark:bg-[#2f3134]  dark:text-white">
    <div class="order-2 lg:order-none border p-8 flex flex-col gap-8 rounded-md shadow-md border-black bg-[#edf0f0] md:w-auto w-screen mt-10 dark:bg-[#232529] dark:text-white dark:border-[#454648]">
