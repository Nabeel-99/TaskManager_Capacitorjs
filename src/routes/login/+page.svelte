...
<div class="flex flex-col gap-8 lg:gap-8  lg:flex-row min-h-[100vh] transition-all duration-200   p-10 rounded-md items-center lg:justify-around px-14 bg-[#f5f5f5] dark:bg-[#2f3134]  dark:text-black">
    ...
    <div class="order-1">
        <img src={loginImage} alt="login" class="h-36 md:h-72 dark:filter dark:hue-rotate-180 dark:brightness-100" />
    </div>
