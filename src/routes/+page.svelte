...
<div class="flex flex-col justify-center text-center items-center gap-2">
    <h1 class="md:text-[3rem] text-2xl font-bold leading-tight tracking-tight ">Welcome to My Task Manager</h1>
    <p class="md:text-base md:whitespace-pre-wrap ">Organize and prioritize your workload to maintain focus and enhance productivity effortlessly. 
Our intuitive tools offer flexibility, empowering you to efficiently manage tasks with ease.
