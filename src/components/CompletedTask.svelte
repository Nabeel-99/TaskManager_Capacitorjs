...
<div transition:fade={{ duration: 300 }} class="flex flex-col gap-2">
  ...
  {#if showCards}
    <div
      class="grid grid-flow-col xl:grid-rows-1 xl:grid-flow-row gap-6 overflow-scroll pb-10"
    >
      ...
      {#each completedTasks as task}
        <div
          ...
          class="flex flex-col w-72 justify-between gap-3 border-2 rounded-lg shadow-lg p-3 dark:bg-[#3f4247] dark:border-none"
        >
          <div class="flex flex-col gap-3">
            <div class="flex justify-between items-center">
              ...
              <div class="flex gap-4">
                <button
                  ...
                  ><i class="fa-solid fa-eye" title="view task"></i></button
                >
            ...
            <h4 class="text-md dark:text-[#a0a1a4] italic">
            ...
            <div class="flex gap-2">
              {#each task.tags as tag}
                <h4
                  class="text-md px-2 py-1 rounded-lg bg-[#7864F4] text-white"
                >
                  {tag}
                </h4>
              {/each}
          ...
          {#if task.completedAt}
            <h4 class="text-md italic dark:text-[#a0a1a4]">
              <span class="">Completion date: </span>{task.completedAt
                .toDate()
              ...
              <td class="px-4 py-2">
                <div class="flex gap-4">
                  ...
                  <button
                    on:click={() => removeTask(task)}
                    class="text-sm bg-gray-200 dark:bg-gray-700 dark:text-white px-2 py-1 rounded-md hover:bg-gray-300 dark:hover:bg-gray-600"
                    ><i class="fa-solid fa-trash" title="delete task"
                    ></i></button
                  >
                </div>
              </td>
